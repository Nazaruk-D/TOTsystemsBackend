...
exports.fetchUserMessages = void 0;
const supabase_1 = require("../../supabase/supabase");
function fetchUserMessages(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data: incomingMessage, error: incomingMessageError } = yield supabase_1.supabase
            .from('messages')
            .select('*')
            .eq('recipient_id', userId);
        const { data: sentMessage, error: sentMessageError } = yield supabase_1.supabase
            .from('messages')
            .select('*')
            .eq('sender_id', userId);
